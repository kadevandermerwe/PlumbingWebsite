        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h1 className="font-heading font-bold text-4xl md:text-5xl lg:text-6xl leading-tight">
              Reliable Plumbing, <span className="text-secondary-light">Done Right</span>
            </h1>
            <p className="mt-4 text-lg md:text-xl opacity-90 max-w-md">
              Your trusted local plumber serving the community with quality workmanship and honest pricing since 2005.
            </p>
            ...
            <div className="mt-8 flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm">Over 500+ happy customers</p>
              </div>
            </div>
          </div>
