        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <p className="mt-4 text-lg md:text-xl opacity-90 max-w-md">
              Your friendly local plumber, providing top-notch workmanship and value for money across Lincoln and Lincolnshire since 2005.
            </p>
            ...
            <div className="mt-8 flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm">Over 500+ happy customers in Lincolnshire</p>
              </div>
            </div>
          </div>
